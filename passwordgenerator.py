...
label_characters=Label(root,text="Number of characters",font=("Arail",12)).pack(padx=10)
...
Button(root,text="Generate Password",command=generate_password,font=("Arial",14)).pack(padx=10)
